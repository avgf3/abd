...
// تم إزالة الذاكرة المحلية - النظام يعتمد على قاعدة البيانات فقط

// تم إزالة دالة updateUserLastSeen - النظام يعتمد على قاعدة البيانات فقط

// تم إزالة جميع الدوال التي تعتمد على الذاكرة المحلية - النظام يعتمد على قاعدة البيانات فقط

// تم إزالة دالة getOnlineUserCountForRoom - النظام يعتمد على قاعدة البيانات فقط

// تم إزالة دالة getUserActiveRooms - النظام يعتمد على قاعدة البيانات فقط

...
export const FRAME_CONFIG: Record<AvatarFrameId, FrameConfig> = {
  ...
  'enhanced-crown-frame': { thicknessRatio: 0.18, listClipTopPercent: 35 },
  'crown-frame-silver': { thicknessRatio: 0.18, listClipTopPercent: 30 },
  'crown-frame-rosegold': { thicknessRatio: 0.18, listClipTopPercent: 30 },
  'crown-frame-blue': { thicknessRatio: 0.18, listClipTopPercent: 30 },
  'crown-frame-emerald': { thicknessRatio: 0.18, listClipTopPercent: 30 },
  'crown-frame-purple': { thicknessRatio: 0.18, listClipTopPercent: 30 },
  'crown-frame-classic-gold': { thicknessRatio: 0.18, listClipTopPercent: 0 },
  'crown-frame-classic-coolpink': { thicknessRatio: 0.18, listClipTopPercent: 0 },
  'svip1-frame-gold': { thicknessRatio: 0.18, listClipTopPercent: 28 },
  'svip1-frame-pink': { thicknessRatio: 0.18, listClipTopPercent: 28 },
  'svip2-frame-gold': { thicknessRatio: 0.18, listClipTopPercent: 28 },
  'svip2-frame-pink': { thicknessRatio: 0.18, listClipTopPercent: 28 },
...
export function getFrameImagePath(frameId: AvatarFrameId): string | undefined {
  ...
  // Frame SVGs are stored at the public root (client/public) as /<frameId>.svg
  return `/${frameId}.svg`;
}

        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-300">
              موقعنا غير مخصص للأطفال دون سن 13 عامًا. نحن لا نجمع عن قصد معلومات شخصية من الأطفال دون هذا السن. 
              إذا علمنا أن طفلاً دون 13 عامًا قد زودنا بمعلومات شخصية، سنقوم بحذفها فورًا.
            </p>
          </section>

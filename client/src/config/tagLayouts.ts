...
export const TAG_LAYOUTS: Record<number, TagLayout> = (() => {
  ...
  override(1,  { widthRatio: 1.10, yAdjustPx: 0, anchorY: 0.05 });
  // tag2: ملكي أنيق
  ...
  // tag8: بسيط — يلامس الحافة العلوية للصورة الشخصية تماماً
  override(8,  { widthRatio: 1.10, yAdjustPx: 0, anchorY: 0.05 });
  // tag9: مزخرف

...
export const TAG_LAYOUTS: Record<number, TagLayout> = (() => {
  ...
  // tag1: كلاسيكي بسيط — خفض التاج ليكون أقرب للرأس
  override(1,  { widthRatio: 1.10, yAdjustPx: 2, anchorY: 0.35 });
  // tag2: ملكي أنيق
  ...
  // tag8: بسيط — خفض التاج ليكون أقرب للرأس
  override(8,  { widthRatio: 1.10, yAdjustPx: 2, anchorY: 0.35 });
  // tag9: مزخرف

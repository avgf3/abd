...
>(({ className, children, ...props }, ref) => {
  // Provide a stable, auto-generated description id to avoid aria-describedby warnings
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        aria-describedby={(props as any)?.['aria-describedby'] ?? descriptionId}
        className={cn(
        ...
        {...props}
      >
        {/* Ensure a hidden description node always exists */}
...
// A floating dialog content variant without an overlay, suitable for non-modal popups
// like a mini YouTube player that should not block or dismiss on outside clicks.

      ...
      React.memo(({ user }: { user: ChatUser }) => {
        ...
        return (
          <li key={user.id} className="relative list-none">
            ...
            >
              <div
                className={`flex items-center gap-2 py-1.5 px-0 rounded-none transition-colors duration-200 cursor-pointer w-full ${getUserListItemClasses(user) || 'bg-card hover:bg-accent/10'}`}

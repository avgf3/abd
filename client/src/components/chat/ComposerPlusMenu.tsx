    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          disabled={disabled}
          className={`chat-plus-button mobile-touch-button ${isMobile ? 'h-11 w-11' : 'h-10 w-10'} rounded-lg px-0 border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground focus:outline-none focus-visible:outline-none`}
          title="خيارات"

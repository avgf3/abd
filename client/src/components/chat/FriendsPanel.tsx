...
export default function FriendsPanel({ 
  ...
  const fetchFriendRequests = async () => {
    ...
    try {
      ...
      const incoming = incomingResponse.ok && incomingResponse instanceof Response ? await incomingResponse.json() : { requests: [] };
      const outgoing = outgoingResponse.ok && outgoingResponse instanceof Response ? await outgoingResponse.json() : { requests: [] };

#!/usr/bin/env python3
"""
Frame 16 Animation - CIRCULAR Lightning (like frame 14)
- NO wing movement
- Lightning travels in circular path around frame
"""
...
def create_circular_lightning_animation(input_path, output_path, num_frames=60, duration=50):
    ...
    """
    print("\n" + "⚡ " + "="*70)
    print("⚡  FRAME 16 - CIRCULAR LIGHTNING (مثل frame 14)")
    print("⚡ " + "="*70 + "\n")
    ...
    print("✨ Features:")
    print("   ✓ Frame STATIC")
    print("   ✓ Lightning travels CIRCULAR")
    print("   ✓ 360° rotation")
    print("   ✓ Same as frame 14\n")

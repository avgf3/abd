...
export const DEFAULT_LEVELS = [
  ...
  { level: 11, requiredPoints: 4000, title: "فارس الألماس", color: "#f8fafc" },
  { level: 12, requiredPoints: 5000, title: "محارب الألماس", color: "#f1f5f9" },
  { level: 13, requiredPoints: 6500, title: "قائد الألماس", color: "#e2e8f0" },
  { level: 14, requiredPoints: 8000, title: "نبيل الألماس", color: "#cbd5e1" },
  { level: 15, requiredPoints: 10000, title: "أمير الألماس", color: "#94a3b8" },
  { level: 16, requiredPoints: 12500, title: "دوق الألماس", color: "#64748b" },
  { level: 17, requiredPoints: 15000, title: "ملك الألماس", color: "#475569" },
  { level: 18, requiredPoints: 18000, title: "إمبراطور الألماس", color: "#334155" },
  { level: 19, requiredPoints: 22000, title: "أسطورة الألماس", color: "#1e293b" },
  { level: 20, requiredPoints: 27000, title: "إله الألماس", color: "#0f172a" },
  // المستويات الزمردية
  { level: 21, requiredPoints: 33000, title: "فارس الزمرد", color: "#10b981" },
  { level: 22, requiredPoints: 40000, title: "محارب الزمرد", color: "#059669" },
  { level: 23, requiredPoints: 48000, title: "قائد الزمرد", color: "#047857" },
  { level: 24, requiredPoints: 57000, title: "نبيل الزمرد", color: "#065f46" },
  { level: 25, requiredPoints: 67000, title: "أمير الزمرد", color: "#064e3b" },
  { level: 26, requiredPoints: 78000, title: "دوق الزمرد", color: "#022c22" },
  { level: 27, requiredPoints: 90000, title: "ملك الزمرد", color: "#14532d" },
  { level: 28, requiredPoints: 104000, title: "إمبراطور الزمرد", color: "#166534" },
  { level: 29, requiredPoints: 120000, title: "أسطورة الزمرد", color: "#15803d" },
  { level: 30, requiredPoints: 138000, title: "إله الزمرد", color: "#16a34a" },
  // المستويات النارية
  { level: 31, requiredPoints: 158000, title: "فارس النار", color: "#f97316" },
  { level: 32, requiredPoints: 180000, title: "محارب النار", color: "#ea580c" },
  { level: 33, requiredPoints: 204000, title: "قائد النار", color: "#dc2626" },
  { level: 34, requiredPoints: 230000, title: "نبيل النار", color: "#b91c1c" },
  { level: 35, requiredPoints: 258000, title: "أمير النار", color: "#991b1b" },
  { level: 36, requiredPoints: 288000, title: "دوق النار", color: "#7f1d1d" },
  { level: 37, requiredPoints: 320000, title: "ملك النار", color: "#450a0a" },
  { level: 38, requiredPoints: 354000, title: "إمبراطور النار", color: "#7c2d12" },
  { level: 39, requiredPoints: 390000, title: "أسطورة النار", color: "#9a3412" },
  { level: 40, requiredPoints: 428000, title: "إله النار", color: "#c2410c" },
];
